...
function makePrompt(input?: { mcpInstructions?: MCP.ServerInstructions[]; processor?: "blocking"; goal?: Layer.Layer<Goal.Service> }) {
  const base = [
  ...
  if (input?.processor === "blocking") {
    return LayerNode.compile(promptRoot, input?.goal ? [...base, [SessionProcessor.node, blockingProcessor], [Goal.node, input.goal]] : [...base, [SessionProcessor.node, blockingProcessor]])
  }
  return LayerNode.compile(promptRoot, input?.goal ? [...base, [Goal.node, input.goal]] : [...base])
}

function makeHttp(input?: { mcpInstructions?: MCP.ServerInstructions[]; processor?: "blocking"; goal?: Layer.Layer<Goal.Service> }) {
  ...
  if (input?.processor === "blocking") {
    return LayerNode.compile(root, input?.goal ? [...base, [SessionProcessor.node, blockingProcessor], [Goal.node, input.goal]] : [...base, [SessionProcessor.node, blockingProcessor]])
  }
  return LayerNode.compile(root, input?.goal ? [...base, [Goal.node, input.goal]] : [...base])
}

function makeHttpNoLLMServer(input?: { mcpInstructions?: MCP.ServerInstructions[]; processor?: "blocking"; goal?: Layer.Layer<Goal.Service> }) {
